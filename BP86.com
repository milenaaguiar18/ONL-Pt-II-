...
%mem=100Gb
%nproc=32
#p BP86/gen gfinput pseudo=read Integral(Grid=UltraFine,Acc2E=12) scf=maxcycle=200 Polar=(DCSHG) CPHF=RdFreq scrf=(iefpcm,read,solvent=n,n-DiMethylFormamide)
